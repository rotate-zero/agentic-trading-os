...
**Version:** 2.10 (Pre-Implementation) — §1, §4.5, §4.11 updated for the chart→Feature Engine migration (`confirmed-decisions.md` #50–51; full plan: `feature-engine-chart-migration.md`); §4.5 also notes the Daily Levels direction lock (`confirmed-decisions.md` #59; full plan: `daily-levels-design.md`)
